...
4. **Analyze the changes:**
   - Extract ticket references from commit messages (patterns like `PROJ-123`)
...
6. **Guidelines:**
   ...
   - **Omit empty sections:** No placeholder text
   - **No filler:** Don't include HTML comments or unchecked checkbox lists

7. **Output** the PR description in a markdown code block for easy copying.

## Example

**Input:** Branch with 3 commits adding authentication
...
## Summary
- Add login/signup forms with email validation
...
## Testing Done
- Verified login flow in development
- Tested token refresh on expiration
- Confirmed protected routes redirect to login
```
